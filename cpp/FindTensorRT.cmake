...
set(_TensorRT_SEARCH_NORMAL
  PATHS "/usr"
  # PATHS "/disk/tool/TensorRT-8.4.2.4"
)
list(APPEND _TensorRT_SEARCHES _TensorRT_SEARCH_NORMAL)

# Include dir (support Debian/Ubuntu multiarch layout, e.g. NGC containers)
...
if(NOT TensorRT_LIBRARY)
  foreach(search ${_TensorRT_SEARCHES})
    find_library(TensorRT_LIBRARY NAMES nvinfer ${${search}}
                 PATH_SUFFIXES lib lib/x86_64-linux-gnu)
    find_library(NVOnnxParser NAMES nvonnxparser ${${search}}
                 PATH_SUFFIXES lib lib/x86_64-linux-gnu)
  endforeach()
endif()
